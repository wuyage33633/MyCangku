...
public class GoodsController {
	...
	public PageResult search(@RequestBody TbGoods goods, int page, int rows  ){
		return goodsService.searchPage(goods, page, rows);		
	}
	
	@RequestMapping("/productshenhe")
	public Result productShenHe(String status,Long [] ids){
		try {
			goodsService.produceShenPi(ids, status);
